...
const Firstview = () => {
  ...
  return (
    ...
    <div onClick={() => dispatch(updateState())} className='hover:cursor-pointer  transition ease-in-out duration-700  flex bg-gray-400 border-2 border-gray-600 rounded-md w-full p-2 bg-opacity-5 hover:bg-opacity-30'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <small><h1 className='mb-1'>Create A todo Branch 🍃 </h1><p>This funtiion Helps you to organize all your todo's in one area</p></small>
    </div>
