...
import { updateTodoState, updateEditState, updatedeleteState } from '../features/formState/formSlice';
...
const Project = () => {
    ...
    const dissy = (title, sid) => {
      // console.log(sid)
      dispatch(updatedeleteState({title, sid}))
    }
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.3} onClick={() => dissy(todo.Todo_title, todo._id)}stroke="currentColor" className="w-6 h-6 text-red-400 cursor-pointer bg-red-100 rounded-full p-1">
